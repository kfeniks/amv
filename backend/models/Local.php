...
class Local extends ActiveRecord
{
    ...
    {
        return [
            [['local_url', 'url', 'file_size', 'format_id', 'codec_audio_id', 'codec_vid_id', 'check_availab', 'user_id', 'videos_id', 'check_id', 'load_count'], 'required', 'message'=>'{attribute} не может быть пустым'],
