...
<div class="user-form">
    ...
    <?php if ($model->img !== null){?>
        <img src="/frontend/web/images/posts/<?= Html::encode($model->img) ?>" style="width: 500px; height: 333px;" alt="<?= Html::encode($this->title) ?>" />
    <?php } ?>
    <?= $form->field($model, 'title')->textInput(['maxlength' => true]) ?>
    <?= $form->field($model, 'meta_key')->textInput(['maxlength' => true])->hint('Введите мета-кей 70зн') ?>
    <?= $form->field($model, 'meta_desc')->textInput(['maxlength' => true])->hint('Введите мета-описание 200зн') ?>
    <?= $form->field($model, 'intro_text')->textInput()->hint('Введите демо текст') ?>
